...
<div class="main-content">
	...
	<!-- /.main-content -->
	 ...
	 <script type="text/javascript">
		...
		$("#btnDelete").click(function(){ // bấm nút -> call api
			var data = {};	
		...
		function deleteNew(data) {
			...
			$.ajax({
				url: '${APIurl}', // link api
				type: 'DELETE', // Phương thức muốn gọi trong API
				...
				success: function (result) {
					// sau khi xóa xong, chuyển hướng tới trang này -> để reload lại trang
					window.location.href = "${NewURL}?type=list&page=1&maxPageItem=5&sortName=title&sortBy=desc&message=delete_success";	
				},
